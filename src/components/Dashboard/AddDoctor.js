...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('service', () => fetch(`https://secret-gorge-44931.herokuapp.com/service`).then(res => res.json())
    )
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch(`https://secret-gorge-44931.herokuapp.com/doctor`, {
                        method: 'POST',
                        headers: {
